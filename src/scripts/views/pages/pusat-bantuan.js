const Bantuan = {
  async render() {
      ...
      <div class="pusat-bantuan">
        <h2 class="pusat-bantuan-title">Pusat Bantuan</h2>
          <h3 class="pusat-bantuan-subTitle">Registrasi Akun Perusahaan</h3>
              ...
              <p>
                ...
                lengkap untuk memastikan proses verifikasi berjalan lancar.
              </p>
              <p>
                3.Klik tombol &quot;Create&quot; untuk menyelesaikan pendaftaran.
              </p>
              <p>
                4.Setelah verifikasi selesai, Anda dapat memasang lowongan pekerjaan
        ...
        <p>
          2.Login ke akun perusahaan Anda dengan memasukkan username dan password yang
          telah didaftarkan.
        </p>
        <p>
        ...
        <p>
          4.Isi formulir iklan lowongan kerja dengan lengkap.
        </p>
        <p>
